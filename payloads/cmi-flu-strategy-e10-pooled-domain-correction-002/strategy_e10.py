...
# Outcome-independent runtime-contract repair: Task1.2 contains a valid five-row
# source study.  The former threshold of 8 was an implementation-only guardrail,
# not part of the predeclared E10 scientific plan.
