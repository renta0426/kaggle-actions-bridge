"""Build the private Kaggle T4 runtime/fidelity gate for hidden-state LUMIA."""
...
OUT_DIR = ROOT / "notebooks/experiments/poisoned-chalice-lumia-hs-runtime-50-v1"
...
print("LUMIA_RUNTIME_INSTALL PASS")
'''
...
print("LUMIA_HIDDEN_STATE_RUNTIME_PILOT COMPLETE performance_metrics=0 sample_outputs=0")
print(json.dumps({
...
nb.cells = [
    nbformat.v4.new_markdown_cell(
        "# LUMIA hidden-state runtime/fidelity gate — 50 public-train rows\n\n"
        "No AUC/TPR/pAUC or competition submission is computed. The purpose is to validate the "
        "released 8192-token all-layer activation mechanism and estimate the 1,000-row pilot runtime."
    ),
...
for index, cell in enumerate(nb.cells):
    cell["id"] = f"lumia-runtime-{index:02d}"
...
metadata = {
    ...
    "keywords": ["gpu", "membership-inference", "lumia", "runtime-pilot"],
    "dataset_sources": [],
    "kernel_sources": [],
    "competition_sources": [],
    "model_sources": [],
