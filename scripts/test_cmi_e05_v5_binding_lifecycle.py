#!/usr/bin/env python3
"""Regression for E05 006 adapter binding, validation and aggregate output lifecycle."""
...
def main() -> int:
    ...
    a = p.parse_args()
    ns = runpy.run_path(str(a.runtime), run_name="e05_v5_binding_lifecycle")
    assert ns["REQUEST_ID"] == "20260907-cmi-flu-strategy-e05-hai-donor-strain-006"
    assert ns["TARGET_KERNEL"] == "renta0426/cmi-flu-e05-hai-donor-strain-20260907-006"
    assert ns["SCIENCE_COMMIT"] == "8209ee237dace5ee383d7983d3d56f2e845dfdca"
    assert ns["E05_V2_BLOB"] == "50951807d28418bb50f4e9dba656fa2b3e4d86ff"
    assert ns["E05_V3_BLOB"] == "129a4a5713a758d58adbb02489105e17a1c13922"
    assert ns["HAI_TRANSFER_V2_BLOB"] == "ebf4110df4ab49d726d80af03c1203f93e9c89c0"
    ...
    print("CMI_FLU_E05_V5_BINDING_LIFECYCLE_PASS adapters=true validation=true files=true")
    return 0
