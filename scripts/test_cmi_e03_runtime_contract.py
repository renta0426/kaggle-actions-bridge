...
EXPECTED_PACKAGE = "48ff4ed2eadec8b059b8d37fb677af1f249b6486bccfbd55dca2274cfc6f3dc3"
EXPECTED_CONDITIONS = (
    "b21",
...
def main() -> int:
    ...
    # The science-source safety guard must remain present, but construct its
    # forbidden markers without making the runtime scanner match itself.
    if 'cli_submit_marker = "kaggle competitions " + "submit"' not in text:
        raise SystemExit("generated E03 runtime lost CLI submission-source guard")
    if 'api_submit_marker = "competition_" + "submit"' not in text:
        raise SystemExit("generated E03 runtime lost API submission-source guard")
    ...
    print(
        ...
        f"package_sha256={EXPECTED_PACKAGE} submission_guard=true"
    )
    return 0
