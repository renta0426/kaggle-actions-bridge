#!/usr/bin/env python3
"""Validate E03 repair request 002 outputs using the frozen E03 sanitizer contract."""
...
def main() -> int:
    spec = importlib.util.spec_from_file_location("cmi_flu_strategy_e03_sanitize_base", BASE)
